...
const HorizontalDividerComponent: ComponentStory<typeof HorizontalDivider> = ({
  space,
  css,
}) => {
  return (
    <Flex
      align="center"
      direction="column"
      css={{ width: "max-content", bg: "$surface_bright", p: "$8", r: "$4" }}
    >
      <ul
        style={{
          listStyle: "none",
      ...
      >
        ...
        <HorizontalDivider
          space={space}
          css={{ bg: "$on_primary_medium", width: "80px", ...css }}
        />
