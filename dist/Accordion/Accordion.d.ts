...
export declare const AccordionRoot: import("@stitches/react/types/styled-component").StyledComponent<React.ForwardRefExoticComponent<(BaseAccordion.AccordionSingleProps | BaseAccordion.AccordionMultipleProps) & React.RefAttributes<HTMLDivElement>>, {}, {
    allowMotion: string;
    sm: string;
    md: string;
    lg: string;
...
export declare const AccordionItem: import("@stitches/react/types/styled-component").StyledComponent<React.ForwardRefExoticComponent<BaseAccordion.AccordionItemProps & React.RefAttributes<HTMLDivElement>>, {}, {
    allowMotion: string;
    sm: string;
    md: string;
    lg: string;
