...
import {
  HLSPlaybackState,
  HMSHLSPlayer,
  HMSHLSPlayerEvents as HMSHLSPlayerEvents2
...
function HlsStatsOverlay({ hlsStatsState, onClose }) {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(HlsStatsRow, { label: "Connection speed" }, `${((hlsStatsState == null ? void 0 : hlsStatsState.bandwidthEstimate) / (1e3 * 1e3)).toFixed(
      2
    )} Mbps`),
...
var SeekControl = ({
  ...
  return /* @__PURE__ */ React5.createElement(Tooltip, { title, side: "top" }, /* @__PURE__ */ React5.createElement(
    IconButton,
    {
      onClick,
...
var VideoProgress = ({
  ...
  const setProgress = useCallback(() => {
    ...
    const videoProgress2 = Math.floor(
      getPercentage(videoEl.currentTime, duration)
    );
    let bufferProgress2 = 0;
    if (videoEl.buffered.length > 0) {
      bufferProgress2 = Math.floor(
        getPercentage((_a = videoEl.buffered) == null ? void 0 : _a.end(0), duration)
      );
    }
...
var VolumeIcon = ({
  ...
  return volume < 50 ? /* @__PURE__ */ React9.createElement(
    VolumeOneIcon,
    {
      style: { cursor: "pointer", transition: "color 0.3s" },
      onClick
...
var FullScreenButton = ({
  ...
  return /* @__PURE__ */ React10.createElement(Tooltip, { title: `${isFullScreen ? "Exit" : "Go"} fullscreen`, side: "top" }, /* @__PURE__ */ React10.createElement(
    IconButton,
    {
      css: { margin: "0px" },
      onClick: onToggle,
    ...
    /* @__PURE__ */ React10.createElement(Flex, null, isFullScreen ? /* @__PURE__ */ React10.createElement(ShrinkIcon, null) : /* @__PURE__ */ React10.createElement(ExpandIcon, null))
  ));
};
...
function HLSQualitySelector({
  ...
  return /* @__PURE__ */ React13.createElement(
    ...
    /* @__PURE__ */ React13.createElement(Dropdown.Trigger, { asChild: true, "data-testid": "quality_selector" }, /* @__PURE__ */ React13.createElement(
      Flex,
      {
        css: {
          color: "$on_primary_high",
...
var HLSViewTitle = () => {
  ...
  return /* @__PURE__ */ React14.createElement(
    ...
    /* @__PURE__ */ React14.createElement(Flex, { direction: "column" }, title ? /* @__PURE__ */ React14.createElement(Text, { variant: "sub2", css: { fontWeight: "$semiBold" } }, title) : null, /* @__PURE__ */ React14.createElement(Flex, null, /* @__PURE__ */ React14.createElement(RoomDetailsRow, { details }), description ? /* @__PURE__ */ React14.createElement(
      Text,
      {
        variant: "caption",
...
var HLSView = () => {
    ...
    (quality) => {
      ...
      if (hlsPlayer) {
        setIsUserSelectedAuto(
          ((_a2 = quality.height) == null ? void 0 : _a2.toString().toLowerCase()) === "auto"
        );
  ...
  useEffect3(() => {
    ...
    const metadataLoadedHandler = (_a2) => {
      ...
      switch (parsedPayload.type) {
        case EMOJI_REACTION_TYPE:
          (_a3 = window.showFlyingEmoji) == null ? void 0 : _a3.call(window, {
            emojiId: parsedPayload == null ? void 0 : parsedPayload.emojiId,
            senderId: parsedPayload == null ? void 0 : parsedPayload.senderId
          });
          break;
        default: {
          const toast = {
    ...
    if (videoEl && hlsUrl) {
      ...
      hlsPlayer.on(
        HMSHLSPlayerEvents2.SEEK_POS_BEHIND_LIVE_EDGE,
        handleNoLongerLive
      );
      hlsPlayer.on(
        HMSHLSPlayerEvents2.TIMED_METADATA_LOADED,
      ...
      hlsPlayer.on(
        HMSHLSPlayerEvents2.CAPTION_ENABLED,
      ...
      return () => {
        ...
        hlsPlayer.off(
          HMSHLSPlayerEvents2.MANIFEST_LOADED,
  ...
  const onClickHandler = useCallback3(() => __async(void 0, null, function* () {
    ...
    match({
      isMobile,
      isLandscape,
      playlist_type: (_a2 = hlsState == null ? void 0 : hlsState.variants[0]) == null ? void 0 : _a2.playlist_type
    }).with(
      {
  ...
  if (!hlsUrl || streamEnded) {
    return /* @__PURE__ */ React15.createElement(React15.Fragment, null, /* @__PURE__ */ React15.createElement(ToggleChat, null), hlsViewRef.current && (isMobile || isLandscape) && /* @__PURE__ */ React15.createElement(Box, { css: { position: "fixed", left: "$4", top: "$4", zIndex: 11 } }, /* @__PURE__ */ React15.createElement(
      LeaveRoom,
      {
  ...
  return /* @__PURE__ */ React15.createElement(
    ...
    hlsViewRef.current && (isMobile || isLandscape) && /* @__PURE__ */ React15.createElement(Box, { css: { position: "fixed", left: "$4", top: "$4", zIndex: 11 } }, /* @__PURE__ */ React15.createElement(
      LeaveRoom,
      {
        screenType: "hls_live_streaming",
        container: hlsViewRef.current
    ...
    /* @__PURE__ */ React15.createElement(HMSPlayerContext.Provider, { value: { hlsPlayer } }, (hlsStatsState == null ? void 0 : hlsStatsState.url) && enablHlsStats && !(isMobile || isLandscape) ? /* @__PURE__ */ React15.createElement(
      HlsStatsOverlay,
      {
        hlsStatsState,
      ...
      !(isMobile || isLandscape) && /* @__PURE__ */ React15.createElement(
      ...
      /* @__PURE__ */ React15.createElement(
        ...
        /* @__PURE__ */ React15.createElement(React15.Fragment, null, !(isMobile || isLandscape) && /* @__PURE__ */ React15.createElement(
          ...
          ((_e = hlsState == null ? void 0 : hlsState.variants[0]) == null ? void 0 : _e.playlist_type) === HLSPlaylistType.DVR ? /* @__PURE__ */ React15.createElement(
          ...
          /* @__PURE__ */ React15.createElement(
            ...
            /* @__PURE__ */ React15.createElement(HMSVideoPlayer.Controls.Left, null, !(isMobile || isLandscape) && /* @__PURE__ */ React15.createElement(React15.Fragment, null, ((_f = hlsState == null ? void 0 : hlsState.variants[0]) == null ? void 0 : _f.playlist_type) === HLSPlaylistType.DVR ? /* @__PURE__ */ React15.createElement(React15.Fragment, null, /* @__PURE__ */ React15.createElement(
              HMSVideoPlayer.PlayPauseSeekControls.Button,
              {
                isPaused,
                onSeekTo
              }
            ), !isVideoLive ? /* @__PURE__ */ React15.createElement(HMSVideoPlayer.Duration, null) : null) : null, /* @__PURE__ */ React15.createElement(HMSVideoPlayer.Volume, null)), /* @__PURE__ */ React15.createElement(
              IconButton,
              {
                css: { px: "$2" },
              ...
              /* @__PURE__ */ React15.createElement(
                ...
                /* @__PURE__ */ React15.createElement(Flex, { justify: "center", gap: 2, align: "center" }, /* @__PURE__ */ React15.createElement(
                  Box,
                  {
                    css: {
                      height: "$4",
            ...
            ) : null, isFullScreenSupported ? /* @__PURE__ */ React15.createElement(
              FullScreenButton,
              {
                isFullScreen,
                onToggle: toggle
...
//# sourceMappingURL=HLSView-SYFVT5PO.js.map
